 ...
 * 
 */
@WebServlet(name = "PaginaInicial", asyncSupported = false, urlPatterns = "/pages/paginainicial")
public class PaginaInicialServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse response)
		...
		try {
			...
			Logger.getLogger(PaginaInicialServlet.class.getName()).log(Level.SEVERE, "Erro ao direcionar para pagina inicial");
